...
<head>
    ...
    <title>GetMe Hired | List Package</title>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center py-5 px-5">
                        ...
                        <a href="/payment" class="btn btn-primary d-flex justify-content-center">Choose Plan</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
