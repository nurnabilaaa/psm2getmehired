                ...
                <div class="table-responsive">
                    <table class="table m-0">
                        ...
                        <tr>
                            ...
                            <td>Siti Faezah Binti Ab Rasit</td>
                            <td><span class="badge badge-success">Accepted</span></td>
                            <td>
                                <div class="sparkbar" data-color="#00a65a" data-height="20">Congratulations! You have been accepted.</div>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="pages/examples/invoice.html">OR1848</a></td>
                            <td>Nabilah Binti Ahmad Jais</td>
                            <td><span class="badge badge-warning">Pending</span></td>
                            <td>
                                <div class="sparkbar" data-color="#f39c12" data-height="20">Your application is still not yet check.</div>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="pages/examples/invoice.html">OR7429</a></td>
                            <td>Nur Fazirah Binti Bakri</td>
                            <td><span class="badge badge-danger">Rejected</span></td>
                            <td>
                                <div class="sparkbar" data-color="#f56954" data-height="20">We are sorry to inform you that your application is rejected.</div>
                            </td>
                        </tr>
                        <tr>
                            <td><a href="pages/examples/invoice.html">OR7429</a></td>
                            ...
                            <td>
                                <div class="sparkbar" data-color="#00c0ef" data-height="20">Your application is still in review.</div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
