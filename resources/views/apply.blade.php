...
<div class="wrapper">
  ...
  <!-- Main content -->
  <main class="py-4">
    <input type="hidden" name="_token" value="qnXNqWGMBdGiw47PqPFsCJSpVgxUPPp0tp2wQ9Ni">    <div class="row d-flext justify-content-center mt-5 px-5">
        <div class="col-md-8">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" value="testing2" required disabled>
            </div>
        </div>
        <div class="col-md-8">
            <div class="form-group">
                <label>Email Address</label>
                <input type="email" class="form-control" value="testing2@gmail.com" required disabled>
            </div>
        </div>
        <div class="col-md-8">
            <div class="form-group">
