            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        ...
                        <p>
                            Get your CV being review by our professional.
                        </p>
                        <a href="/select" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Buy Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        ...
                        <p>
                            Get your job as a proofreader.
                        </p>
                        <a href="/apply" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Apply Now</a>
                    </div>
                </div>
            </div>
        </div>
