            ...
            <div class="row d-flext justify-content-center mt-5 px-5">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Phone Number" value="{{ $consultant_info->phoneno }}" name="phoneno"
                               onkeypress="return onlyNumberKey(event)" min="10" maxlength="11" required>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
