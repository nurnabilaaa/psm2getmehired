            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        ...
                        <h3 class="mt-3">Update Package</h3>
                        <a href="/update" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Update Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        <i class="fas fa-sign-in-alt text-primary fa-5x d-flex justify-content-center"></i>
                        <h3 class="mt-3">Check New CV Review</h3>
                        <a href="#" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Check Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        <i class="fas fa-toggle-on text-primary fa-5x d-flex justify-content-center"></i>
                        <h3 class="mt-3">Notify CV Progress</h3>
                        <a href="#" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Notify Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body py-5 px-5 text-center">
                        <i class="fas fa-user-alt text-primary fa-5x d-flex justify-content-center"></i>
                        <h3 class="mt-3">Check New Application</h3>
                        <a href="#" class="btn btn-primary d-flex justify-content-center mt-4 shadow text-decoration-none">Check Now</a>
                    </div>
                </div>
            </div>
