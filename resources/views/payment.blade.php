...
<head>
    ...
    <title>GetMe Hired | Payment</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="{{ url('chekcout/premium/make-payment') }}" method="POST"
                      data-stripe-publishable-key="pk_test_51Is0JMDaFLLXIVTMSCfVWRJPIQ8CkuiUHo2Q47A8nOrJiVJ2FvFG9xBLSCSbdWGw9tpVuqSj9aHMVJQmz4FVwfb800zju3KukE" autocomplete="off"
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" name="cardnumber" onkeypress="return onlyNumberKey(event)" maxlength="16"
                                       placeholder="exp. 1234567890123456" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <a href="/uploadcv" class="btn btn-primary d-flex justify-content-center">Pay Now</a>
                        </div>
                    </div>
                </form>
            </div>
